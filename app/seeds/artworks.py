...
def seed_artworks():
    ...
    artwork_seed_data = [
        Artwork(title='Starry Night', artist_name='Vincent van Gogh', year=1889, height='73.7 cm', width='92.1 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://images.unsplash.com/photo-1596143831703-964db2e5e5d1?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjEyMDd9',
        ...
        Artwork(title='Mona Lisa', artist_name='Leonardo da Vinci', year=1503, height='77 cm', width='53 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://www.makingitsweet.com/wp-content/uploads/2012/10/tree_sample.jpg',
        ...
        Artwork(title='The Persistence of Memory', artist_name='Salvador Dalí', year=1931, height='24 cm', width='33 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://www.thewowstyle.com/wp-content/uploads/2015/04/740b6_contemporary-art.jpg',
        ...
        Artwork(title='The Starry Night Over the Rhône', artist_name='Vincent van Gogh', year=1888, height='72.5 cm', width='92 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://i.pinimg.com/originals/11/f7/ec/11f7ecab79afb5dd0e930e75f3666e81.jpg',
        ...
        Artwork(title='The Kiss', artist_name='Gustav Klimt', year=1907, height='180 cm', width='180 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://images.unsplash.com/photo-1596143831703-964db2e5e5d1?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjEyMDd9',
        ...
        Artwork(title='The Scream', artist_name='Edvard Munch', year=1893, height='91 cm', width='73.5 cm', available=True, materials=ArtWorkTypesEnum.PASTEL, image='https://cdn.pixabay.com/photo/2017/11/09/12/55/building-2933411_640.png',
        ...
        Artwork(title='Guernica', artist_name='Pablo Picasso', year=1937, height='3.5 m', width='7.8 m', available=True, materials=ArtWorkTypesEnum.OIL, image='https://www.thewowstyle.com/wp-content/uploads/2015/04/740b6_contemporary-art.jpg',
        ...
        Artwork(title='The Birth of Venus', artist_name='Sandro Botticelli', year=1485, height='278 cm', width='172.5 cm', available=True, materials=ArtWorkTypesEnum.TEMPERA, image='https://i.pinimg.com/originals/11/f7/ec/11f7ecab79afb5dd0e930e75f3666e81.jpg',
        ...
        Artwork(title='The Last Supper', artist_name='Leonardo da Vinci', year=1495, height='460 cm', width='880 cm', available=True, materials=ArtWorkTypesEnum.TEMPERA, image='https://www.leonardodavinci.net/images/paintings/the-last-supper.jpg',
        ...
        Artwork(title='The Garden of Earthly Delights', artist_name='Hieronymus Bosch', year=1515, height='220 cm', width='389 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://www.makingitsweet.com/wp-content/uploads/2012/10/tree_sample.jpg',
        ...
        Artwork(title='The Night Watch', artist_name='Rembrandt van Rijn', year=1642, height='379.5 cm', width='453.5 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://i.pinimg.com/originals/11/f7/ec/11f7ecab79afb5dd0e930e75f3666e81.jpg',
        ...
        Artwork(title='Water Lilies', artist_name='Claude Monet', year=1916, height='200 cm', width='180 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://i.pinimg.com/originals/11/f7/ec/11f7ecab79afb5dd0e930e75f3666e81.jpg',
        ...
        Artwork(title='Campbell\'s Soup Cans', artist_name='Andy Warhol', year=1962, height='51 cm', width='41 cm', available=True, materials=ArtWorkTypesEnum.SILKSCREEN, image='https://cdn.pixabay.com/photo/2017/11/09/12/55/building-2933411_640.png',
        ...
        Artwork(title='The School of Athens', artist_name='Raphael', year=1511, height='500 cm', width='770 cm', available=True, materials=ArtWorkTypesEnum.FRESCO, image='https://www.thewowstyle.com/wp-content/uploads/2015/01/nature-images..jpg',
        ...
        Artwork(title='The Hay Wagon', artist_name='John Constable', year=1821, height='130 cm', width='185 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='http://3.bp.blogspot.com/-1N04gdQCTFw/UQrkdm6rr8I/AAAAAAAAA3Y/FMQjOM8IrPY/s1600/z.jpg',
        ...
        Artwork(title='The Kiss', artist_name='Auguste Rodin', year=1889, height='181.9 cm', width='112.1 cm', available=True, materials=ArtWorkTypesEnum.MARBLE, image='https://www.thewowstyle.com/wp-content/uploads/2015/01/nature-images..jpg',
        ...
        Artwork(title='The Starry Night', artist_name='Georgia O\'Keeffe', year=1922, height='76.2 cm', width='101.6 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://st.depositphotos.com/1008304/2438/i/950/depositphotos_24384825-stock-photo-tall-building.jpg',
        ...
        Artwork(title='The Great Wave off Kanagawa', artist_name='Katsushika Hokusai', year=1829, height='25.7 cm', width='37.8 cm', available=True, materials=ArtWorkTypesEnum.WOODBLOCK, image='https://st.depositphotos.com/1008304/2438/i/950/depositphotos_24384825-stock-photo-tall-building.jpg',
        ...
        Artwork(title='Nighthawks', artist_name='Edward Hopper', year=1942, height='84.1 cm', width='152.4 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='http://3.bp.blogspot.com/-1N04gdQCTFw/UQrkdm6rr8I/AAAAAAAAA3Y/FMQjOM8IrPY/s1600/z.jpg',
        ...
        Artwork(title='American Gothic', artist_name='Grant Wood', year=1930, height='74.3 cm', width='62.4 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://cdn.pixabay.com/photo/2017/11/09/12/55/building-2933411_640.png',
        ...
        Artwork(title='The Birth of Venus', artist_name='William-Adolphe Bouguereau', year=1879, height='300 cm', width='218 cm', available=True, materials=ArtWorkTypesEnum.OIL, image='https://cdn.pixabay.com/photo/2017/11/09/12/55/building-2933411_640.png',
