...
export default function reducer(state = initialState, action) {
	...
	switch (action.type) {
		case SET_USER:
			action.payload.artListings = action.payload.artListings.length ? normalizeFn(action.payload.artListings) : {};
			action.payload.auctionListings = action.payload.auctionListings ? normalizeFn(action.payload.auctionListings) : {};
			action.payload.artworks = action.payload.artworks ? normalizeFn(action.payload.artworks) : {};
